...
MODEL_PATHS = ['./run_main', './run_tune']
TEST_FILE_PATHS = ['./test_gpt_verified.json', './test_gpt_TOEFL_verified.json'
    ...
    for test_file in TEST_FILE_PATHS:
        for model_path in MODEL_PATHS:
            ...
            for temp_ans, temp_exp in tqdm(temperature_values):
                ...
                results['model_type'].append(model_path)
                results['dataset'].append(test_file)
