...
if __name__ == '__main__':
    ...
    for temp_ans, temp_exp in tqdm(temperature_values):
        model, tokenizer = load_model(f'./run_{temp_ans}_{temp_exp}/checkpoint-2000')
        model_answer_l = []
        model_evidence_l = []
        ...
        results['answer_temperature'].append(temp_ans)
        results['evidence_temperature'].append(temp_exp)
    ...
    df.to_csv('lr_tuning_results.csv', index=False)
